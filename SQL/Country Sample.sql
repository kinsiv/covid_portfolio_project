...
Monthly, yearly, and overall totals. Smooth attributes used to provide a minorly inaccurate (<2%), yet precise grand total for World.
Population and median ages are subqueried for future correlation examination. */
